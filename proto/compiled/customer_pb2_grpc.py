...
class CustomerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateCustomer = channel.unary_unary(
                '/api.customer.CustomerService/CreateCustomer',
        ...
        self.UpdateCustomer = channel.unary_unary(
                '/api.customer.CustomerService/UpdateCustomer',
        ...
        self.DeleteCustomer = channel.unary_unary(
                '/api.customer.CustomerService/DeleteCustomer',
        ...
        self.GetCustomer = channel.unary_unary(
                '/api.customer.CustomerService/GetCustomer',
...
def add_CustomerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'api.customer.CustomerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('api.customer.CustomerService', rpc_method_handlers)
